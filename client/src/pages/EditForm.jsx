...
const EditForm = ({data}) => {
    ...
    const [status, setStatus] = useState(data.isCompleted ? "true" : "false");
    ...
    return (
        <form className='form-box' onSubmit={handelSubmit}>
            ...
            <button type="submit" className=" mt-3 btn btn-success">Save Task</button>
        </form>
    )
}
